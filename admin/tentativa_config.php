...
//Writing the form
echo '<form method="post" attribute="post" action="tentativa_answer.php?id_dispositivo=' . $id . '" enctype="multipart/form-data" id="mod_disp" name="mod_disp">'; //onsubmit='return validateForm()'>';
...
echo "<p>Put here the new code: </p>";
echo '<textarea cols="60" rows="10" name="program_string"></textarea><br>';

//writting submit button
//we are going to send the id of the form via the function validateFom.
echo '<button type="submit" name="submit_file_change" id="submit_file_change" value="answer">Change Configuration</br></button> </form>';
